...
// Source-Manifest-Digest: sha256:e348a6a3ad7295bebf48712a968bd033003b074dd464294ad6928b1fc3d4bdd6
...
pub(crate) const OFFICIAL_CORE_WORKERS: &[(&str, bootstrap::WorkerAdmissionLane)] = &[
    (
        ...
        bootstrap::WorkerAdmissionLane::Observational,
    ),
    (
        ...
        for domain in execution.local_domains() {
            inputs.push(match domain {
                ...
                assembly_schema::AssemblyDomain::Audit => LocalDomainModuleInput::Audit(
                    crate::domains::audit::AuditModuleInput::from_execution(execution, mapper)?,
                ),
                other => anyhow::bail!(
