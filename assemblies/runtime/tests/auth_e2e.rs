...
/// INVARIANT: BODYLIMIT-BEFORE-AUTH-01 { level = "Medium", exec = "test", source = "code" }tripwire：
...
/// INVARIANT: RATELIMIT-BEFORE-AUTH-01 { level = "Medium", exec = "test", source = "code" }tripwire：
