...
// Registry dependencies receive Cargo's lint cap; a vendored path dependency does not. Preserve
// SQLx 0.8.6 source signatures while keeping RSS's `clippy -D warnings` gate deterministic.
