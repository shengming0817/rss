...
//!
//! INVARIANT: PG-DOMAIN-FEATURES-01 { level = "Medium", exec = "test", source = "trybuild", native = "external consumer compilation proves parent-gated modules and conditional crate-root re-exports remove inactive domain APIs from rustc input" }
