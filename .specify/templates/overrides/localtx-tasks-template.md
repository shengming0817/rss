...
- [ ] [LOCALTX-OPERATIONS] Consume `localtx_retry_attempts_total`, `localtx_final_total`, and `localtx_attempts`; keep actionable settlement alerts in `docs/ops/localtx-alerts.rules.yaml`.
