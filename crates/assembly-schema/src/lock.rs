//! Canonical AssemblyLock v3 identity protocol.
//!
...
const ASSEMBLY_LOCK_TAG: &str = "rss-assembly-lock-v3";
...
struct SchemaVersionV3;
impl JsonSchema for SchemaVersionV3 {
    fn is_referenceable() -> bool {
        false
    }
    fn schema_name() -> String {
        "AssemblyLockSchemaVersionV3".to_owned()
    }
...
/// Version-three trusted AssemblyLock value, obtainable only through repository verification.
#[derive(Serialize, JsonSchema)]
#[serde(rename_all = "camelCase", deny_unknown_fields)]
pub struct AssemblyLock {
    #[schemars(with = "SchemaVersionV3")]
    schema_version: u32,
...
impl ParsedAssemblyLock {
    /// Parse a closed v3 JSON object and verify its self-excluding fingerprint.
...
/// Immutable presented repository source universe that replays the complete AssemblyLock v3 join.
///
...
"#
    ...
    fn derived_schema_structurally_matches_closed_contract() {
        ...
        let derived = &schema;
        assert_eq!(derived["properties"]["schemaVersion"]["const"], 3);
        assert_eq!(contract["properties"]["schemaVersion"]["const"], 3);
