...
pub mod device_certificate {
    ...
    pub use crate::device_certificate::{
        ...
        DevicePolicyAuthorizationReceipt, DevicePolicyAuthorizationReceiptId,
        DevicePolicyIdempotencyKey, DevicePolicyRequestDigest, DeviceSequence,
        DynDeviceCertificateRepository, DynDeviceCertificateStatusStore, ExpectedGeneration,
        ...
        ReportedStateWrite, RotationOutcome, UnaddressableDeviceIngress,
