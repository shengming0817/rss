...
fn device_certificate_is_exposed_only_through_the_ports_facade() {
    ...
    tests.compile_fail("tests/ui/device_policy_authorized_constructor_is_private_fail.rs");
    tests.compile_fail("tests/ui/device_policy_test_evidence_required_fail.rs");
