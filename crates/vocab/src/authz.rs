...
pub enum RoutePermissionId {
    ...
    IdentityAccountSecurityRead,
    IdentityAccountSecurityWrite,
    IdentityRoleAssign,
    IdentityRoleRead,
    IdentityRoleRevoke,
...
impl RoutePermissionId {
    ...
    pub const ALL: &'static [Self] = &[
        ...
        Self::IdentityAccountSecurityRead,
        Self::IdentityAccountSecurityWrite,
    ...
    pub fn parse(raw: &str) -> Result<Self, PermissionParseError> {
        match raw {
            ...
            "identity:account-security:read" => Ok(Self::IdentityAccountSecurityRead),
            "identity:account-security:write" => Ok(Self::IdentityAccountSecurityWrite),
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::IdentityAccountSecurityRead => "identity:account-security:read",
            Self::IdentityAccountSecurityWrite => "identity:account-security:write",
    ...
    pub const fn variant_name(self) -> &'static str {
        match self {
            ...
            Self::IdentityAccountSecurityRead => "IdentityAccountSecurityRead",
            Self::IdentityAccountSecurityWrite => "IdentityAccountSecurityWrite",
    ...
    fn route_permission_accepts_catalog_values() {
        let cases = [
            ...
            (
                ...
                RoutePermissionId::IdentityAccountSecurityRead,
            ),
            (
                "identity:account-security:write",
                RoutePermissionId::IdentityAccountSecurityWrite,
            ),
            (
