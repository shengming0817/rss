...
//! 覆盖全部 async DI port（DIPORT-DYN-COMPAT-01 回归锁随新增端口同步扩展）：Signer / AuditSink / Subscriber。
use diport::{
    AuditSink, AuditSinkError, DynAuditSink, DynSigner, DynSubscriber, KeyId, MessageStream,
