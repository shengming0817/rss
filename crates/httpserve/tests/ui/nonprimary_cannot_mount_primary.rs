...
fn main() {
    let _internal = unfinalized_for_test::<httpserve::Internal>(|rb| {
        rb.mount_primary(
            httpserve::PrimaryRoute::permission(axum::http::Method::GET, "/x", "ui.fail", RoutePermission { permission: vocab::RoutePermissionId::IdentityPolicyRead, scope: RouteResourceScope::None }),
