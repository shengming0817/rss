//! DECLARED-HTTP-RESPONSE-01: declared OutboxFact producers cannot erase output to Response.
...
async fn handler(_: httpserve::ProducerMarker<RouteMarker>) -> Response { ().into_response() }
