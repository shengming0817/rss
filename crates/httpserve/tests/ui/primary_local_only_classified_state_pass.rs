...
fn main() {
    let read_binding = vocab::HttpRouteBinding::<ReadRouteMarker, vocab::http::LocalOnly>::from_static(
    ...
    let auth_binding = vocab::HttpRouteBinding::<AuthRouteMarker, vocab::http::LocalOnly>::from_static(
        vocab::ContractBinding::from_static(
            "test",
