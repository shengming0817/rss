...
//!
//! INVARIANT: ROUTE-AUTH-FUNNEL-01 · ROUTE-AUTH-FUNNEL-02 · ROUTE-LISTENER-TYPED-01 · ROUTE-ENDPOINT-REQUIRED-01 · ROUTE-MOUNT-NOBYPASS-01 { level = "Medium", exec = "test", source = "trybuild" }
#[test]
fn ui() {
