...
//!
//! 范式同 [`crate::reconcile`] 的 `Trigger::interval` / `RetryPolicy::new`（fail-fast `new()` +
...
//!
//! [`eventing::delivery::DeliveryBudget`] 私有字段 + 唯一
//! [`eventing::delivery::DeliveryBudget::new`] funnel，使零值、非整毫秒、超过 24h operational
