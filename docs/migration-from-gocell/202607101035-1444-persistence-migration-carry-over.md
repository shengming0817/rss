...
| spec-002 | T003.4.a | postgres integration feature and compile harness | done-evidence | #1116,#1435 | no | - | 8d2768d5dd9cdea6cd798b08be506fa12a1724c2 | adapters/postgres/tests/tenant_transaction_trybuild.rs | test: tenant_transaction_ui | implemented |
...
| spec-002 | T006.4.a | AMQP integration feature and adapter harness | done-evidence | #1119,#1438,#1442 | no | - | 8d2768d5dd9cdea6cd798b08be506fa12a1724c2 | adapters/amqp/tests/integration.rs | test: integration_ackable_ack_removes_message | implemented |
...
| schedule-607 | #1119 | AMQP transport | done-evidence | #1119 | no | - | b0e64633980059a88ddd051a6681fc7eefd651c3 | adapters/amqp/src/publisher.rs | test: integration_broker_roundtrip_preserves_message_identity | implemented |
...
| schedule-607 | #1137.c | rabbitmq container-backed integration harness | done-evidence | #1137 | no | - | 8d2768d5dd9cdea6cd798b08be506fa12a1724c2 | adapters/amqp/tests/integration.rs | test: integration_ackable_ack_removes_message | implemented by the closed integration-harness leaf |
...
| crate-mapping | AMQP / MQTT.amqp | lapin durable event transport | done-evidence | #1119,#1438,#1442 | no | - | b0e64633980059a88ddd051a6681fc7eefd651c3 | adapters/amqp/src/publisher.rs | test: integration_broker_roundtrip_preserves_message_identity | implemented |
