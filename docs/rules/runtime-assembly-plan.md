...
- The v2 workflow carrier introduced by #1913 does not itself switch production Projection/Saga registries, DB capture, workers, routes, serving, or runtime inventory. #1914 owns that consumption cutover and its zero-side-effect proof; before it lands, the v2 carrier must not be cited as an established runtime invariant.
