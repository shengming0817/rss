...
- [ ] T028 [US1] Define domain binding/output shape without introducing a runtime DI container.
- [ ] T029 [US1] Add merge/extend helpers while preserving probes/resources/workers semantics.
