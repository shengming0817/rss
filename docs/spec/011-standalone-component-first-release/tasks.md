...
| RSS-NW-013 | #2055 | 独立 Plain Rust component consumer | #2053, #2054 | `rss-incubator` canonical candidate CI 消费 RSS immutable candidate bundle，以独立根 lock 和 registry-only resolution 执行 locked/offline check/test/clippy；RSS `package-proof` 独立拥有逐 package `.crate` correctness |
