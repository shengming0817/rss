...
| C7 sealed/newtype | DI port trait **不跨 crate sealed**（deny.toml wrappers 收敛宏依赖，限依赖非 impl；impl-allowlist 未机器强制、待 #1060；ADR-003 §4.2 方案②）；adapter PR-5 冻 unit sealed-marker，raw client `pub(crate)` 字段延迟 W | ADR-003 §4.2 |
