...
| Production MQTT requires mTLS, stable session and typed ACL | #1902 | Sealed required configuration (Hard); Mosquitto readiness/session tests (Medium) |
