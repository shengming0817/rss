...
| LocalTx settlement | `docs/runbooks/202607130312-1705-localtx-unsafe-settlement.md` | `localtx_retry_attempts_total`, `localtx_final_total`, `localtx_attempts` | `docs/ops/localtx-alerts.rules.yaml` | same checklist | no automatic replay for unsafe settlement | `observ::LocalTxObservation`, typed generated route, closed boundary/retry/final-status enums; see `docs/rules/observability.md` |
