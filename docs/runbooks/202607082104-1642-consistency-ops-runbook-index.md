...
Allowed labels are the closed sets documented in `crates/observ`、`secure::redact_error` 与 typed metric enums. Tenant, message id,
...
`crates/observ`、`secure::redact_error` 与 typed metric enums Metrics Label 有界例外。
