...
Static status: **failed** · Active HTTP contracts: **2** · Findings: **2**

Source receipt registration (report-only; tests not executed): **0/1 registered** · Missing: **1** · Contracts: a.local
