...
integration_shard_catalog! {
    ...
    EventTransport => {
        ...
        units: [
            ...
            MqttAssertionContract => ("mqtt", "assertion_contract", Test, Parallel),
            MqttConfigTopic => ("mqtt", "config_topic", Test, Parallel),
            MqttOwnershipGate => ("mqtt", "ownership_gate", Test, Parallel),
            MqttSessionSurface => ("mqtt", "session_surface", Test, Parallel),
            MqttTlsConfig => ("mqtt", "tls_config", Test, Parallel),
            TestkitMqttMtlsFixture => ("testkit", "mqtt_mtls_fixture", Test, Serial),
            TestkitMqttOwnershipGate => ("testkit", "mqtt_ownership_gate", Test, Parallel),
    ...
    ConsistencyFault => {
        ...
        units: [
            ...
            TestkitWait => ("testkit", "wait", Test, Parallel),
