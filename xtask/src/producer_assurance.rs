...
//!
//! INVARIANT: L2-PRODUCER-EXECUTION-CLOSURE-01 { level = "Medium", exec = "check", source = "code", synthetic_red = "tests::postgres_provider_without_producer_tx_is_rejected|tests::producer_transaction_signature_rejects_wrong_lane", anti_vacuity = "l2_assurance::tests::workspace_typed_inventory_closes_active_l2" }——
